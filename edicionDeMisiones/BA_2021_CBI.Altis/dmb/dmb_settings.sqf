...
DMB_CTRL_NAME_2 = "Flujo del escenario"; // Left section name
DMB_CTRL_NAME_3 = "Toques individuales"; // Right section name
...
DMB_TEXT_1 = "Castigar con flexiones";
...
//Button 1
DMB_ENABLE_AL1 = true;
DMB_CODE_AL1 = {systemChat "call ZR_fnc_comenzarDia"};
DMB_TEXT_AL1 = "Toque de despertar";
...
//Button 1
DMB_ENABLE_AR1 = true;
DMB_CODE_AR1 = {[1] call ZR_fnc_toque};
DMB_TEXT_AR1 = "Reveille (despertar)";

//Button 2
DMB_ENABLE_AR2 = true;
DMB_CODE_AR2 = {[2] call ZR_fnc_toque};
DMB_TEXT_AR2 = "Formar";

//Button 3
DMB_ENABLE_AR3 = true;
DMB_CODE_AR3 = {[3] call ZR_fnc_toque};
DMB_TEXT_AR3 = "Llamado a oficiales";

//Button 4
DMB_ENABLE_AR4 = true;
DMB_CODE_AR4 = {[4] call ZR_fnc_toque};
DMB_TEXT_AR4 = "Cesar actividad";
