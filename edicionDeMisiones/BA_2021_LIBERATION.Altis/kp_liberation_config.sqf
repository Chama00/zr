...
KP_liberation_preset_civilians = 3;
...
GRLIB_sector_cap = 130;                                                 // Cap for sector defenders.
GRLIB_battlegroup_cap = 100;                                            // Cap for enemy battlegroups.
GRLIB_patrol_cap = 100;                                                 // Cap for enemy patrols.
